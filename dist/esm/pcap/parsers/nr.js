import { v } from "../utils";
export function parseFeatureSets(ueNrCapability) {
    var _a, _b;
    ...
    const featureSetsDownlink = (_a = _featureSetsDownlink === null || _featureSetsDownlink === void 0 ? void 0 : _featureSetsDownlink.map((featureSetDownlink) => {
        var _a;
        const featureSetListPerDownlinkCc = (_a = featureSetDownlink.FeatureSetDownlink.featureSetListPerDownlinkCC.map((featureSetDownlinkPerCcId) => +v(featureSetDownlinkPerCcId["FeatureSetDownlinkPerCC-Id"]))) !== null && _a !== void 0 ? _a : [];
    ...
    const featureSetsUplink = (_b = _featureSetsUplink === null || _featureSetsUplink === void 0 ? void 0 : _featureSetsUplink.map((featureSetUplink) => {
        var _a;
        const featureSetListPerUplinkCc = (_a = featureSetUplink.FeatureSetUplink.featureSetListPerUplinkCC.map((featureSetUplinkPerCcId) => +v(featureSetUplinkPerCcId["FeatureSetUplinkPerCC-Id"]))) !== null && _a !== void 0 ? _a : [];

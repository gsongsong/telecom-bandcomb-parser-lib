import { v } from "../utils";
export function parseFeatureSets(ueEutraCapability) {
    ...
    const featureSetsDl = (_0 = featureSetsDlR15 === null || featureSetsDlR15 === void 0 ? void 0 : featureSetsDlR15.map((featureSetDl) => {
        var _a, _b;
        const featureSetPerCcListDlR15 = (_b = (_a = featureSetDl["FeatureSetDL-r15"]["featureSetPerCC-ListDL-r15"]) === null || _a === void 0 ? void 0 : _a.map((featureSetDlPerCcIdR15) => +v(featureSetDlPerCcIdR15["FeatureSetDL-PerCC-Id-r15"]))) !== null && _b !== void 0 ? _b : [];
    ...
    const featureSetsUl = (_2 = featureSetsUlR15 === null || featureSetsUlR15 === void 0 ? void 0 : featureSetsUlR15.map((featureSetUl) => {
        var _a, _b;
        const featureSetPerCcListUlR15 = (_b = (_a = featureSetUl["FeatureSetUL-r15"]["featureSetPerCC-ListUL-r15"]) === null || _a === void 0 ? void 0 : _a.map((featureSetUlPerCcIdR15) => +v(featureSetUlPerCcIdR15["FeatureSetUL-PerCC-Id-r15"]))) !== null && _b !== void 0 ? _b : [];
